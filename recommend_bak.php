...
suspendImg="<DIV id=\"scrollDIV\" style='right:72px;POSITION:absolute;TOP:69px; background:none'> <ul class='product_title'> 您输入的图片如下：</ul>";
suspendImg = suspendImg + "<ul><img border=0 src=include/upload_Img/" + "<?php echo $_GET['imName'];  ?>" + ".jpg></ul></div>";
...
<div class="top_search">
 ...
 <?php
     ...
     $con = mysql_connect('localhost', 'root', 'cbzeng~231715');  
		...
		$userID = $_GET["userID"];
		$sql = "select * from user_recomm where userID='" .$userID. "'" ; 
  ...
  for($i=0; $i<8; $i++)
   {
	...
	$imgPath = '<img src="'.$row_com[4].'"  border=0 width="160px" height="160px"/>';
	...
	echo   '<div class="product_title">来源商家：'.$row_com[6]. '</div>';	
  ...
  ////----------------颜色相似的包包-------------------------------
	...
	$imgPath = '<img src="'.$row_hsv[4].'"  border=0 width="160px" height="160px"/>';
	//$imgPath = htmlspecialchars_decode($imgPath);
	echo   '<div class="prod_box">';
    echo   '<div class="top_prod_box"></div>';
    echo   '<div class="center_prod_box">';            
	...
	echo   '<div class="product_title">来源商家：'.$row_hsv[6]. '</div>';	
	...
	$imgPath = '<img src="'.$row_lbp[4].'"  border=0 width="160px" height="160px"/>';
	$imgPath = htmlspecialchars_decode($imgPath);
	echo   '<div class="prod_box">';
    echo   '<div class="top_prod_box"></div>';
    echo   '<div class="center_prod_box">';            
	...
	echo   '<div class="product_title">来源商家：'.$row_lbp[6]. '</div>';	
